...
export class PanelLayoutManager implements AppModule {
    ...
    setTrustedHtml(this.ctx.container, trustedHtml(`
      ...
      <div class="header" role="banner">
        ...
        return `
          ...
          <span class="logo">GROUNDTRUTH</span><span class="logo-mobile">GROUNDTRUTH</span><span class="version">v${__APP_VERSION__}</span>${BETA_MODE ? '<span class="beta-badge">BETA</span>' : ''}
          <a href="https://x.com/eliehabib" target="_blank" rel="noopener" class="credit-link">
            <svg class="x-logo" width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
            <span class="credit-text">@eliehabib</span>
          </a>
          <a href="https://github.com/williamtheconqueror48-art/groundtruth" target="_blank" rel="noopener" class="github-link" title="${t('header.viewOnGitHub')}" aria-label="${t('header.viewOnGitHub')}">
      ...
      <footer class="site-footer">
        <div class="site-footer-brand">
          ...
          <div class="site-footer-brand-text">
            <span class="site-footer-name">GROUNDTRUTH</span>
            <span class="site-footer-sub">v${__APP_VERSION__} &middot; <a href="https://x.com/eliehabib" target="_blank" rel="noopener" class="site-footer-credit">@eliehabib</a> &middot; originally forked from <a href="https://github.com/koala73/worldmonitor" target="_blank" rel="noopener" class="site-footer-credit">koala73/worldmonitor</a></span>
          </div>
        </div>
        <nav aria-label="GROUNDTRUTH references">
          ${referenceLinksHtml}
          <a href="https://github.com/williamtheconqueror48-art/groundtruth" target="_blank" rel="noopener">Source</a>
          <a href="https://github.com/williamtheconqueror48-art/groundtruth/blob/main/LICENSE" target="_blank" rel="noopener">License (AGPL-3.0)</a>
        ...
        <span class="site-footer-copy">&copy; ${new Date().getFullYear()} GROUNDTRUTH &middot; Originally forked from <a href="https://github.com/koala73/worldmonitor" target="_blank" rel="noopener">koala73/worldmonitor</a></span>
      </footer>
  ...
  private async createPanels(): Promise<void> {
    ...
    // GROUNDTRUTH evidence layer v1 (2026-09-24): raw sourced records + timeline.
    this.lazyDefaultPanel('evidence', () => import('@/components/EvidencePanel'), 'EvidencePanel');
    this.lazyDefaultPanel('evidence-timeline', () => import('@/components/EvidenceTimelinePanel'), 'EvidenceTimelinePanel');
