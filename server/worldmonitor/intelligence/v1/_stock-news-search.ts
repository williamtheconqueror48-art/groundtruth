// Corporate-intelligence stock-headline search, relocated from
// server/worldmonitor/market/v1/stock-news-search.ts after the Tier-3 market
// domain was stripped. Retained for per-company news mentions only.
...
// Local copy of the market-domain upstream timeout (market/v1/_shared.ts
// was stripped with the Tier-3 market domain; this search is retained for
// corporate-intelligence news mentions).
